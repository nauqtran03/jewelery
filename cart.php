        ...
        <div class="order-lg-2 mb-3 mb-lg-0 pt-lg-2">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light flex-lg-nowrap justify-content-center justify-content-lg-start">
                    ...
                    <li class="breadcrumb-item text-nowrap"><a href="shop-grid-ls.html">Cửa hàng</a></li>
            ...
            <?php if (!$is_cart_empty): ?>
                ...
                <section class="col-lg-8">
                    <div class="d-flex justify-content-between align-items-center pt-3 pb-4 pb-sm-5 mt-1">
                        <h2 class="h6 text-light mb-0">Các sản phẩm</h2><a class="btn btn-outline-primary btn-sm ps-2" href="shop.php"><i class="ci-arrow-left me-2"></i>Tiếp tục mua sắm</a>
                    </div>
                    ...
                    <div class="bg-white rounded-3 shadow-lg p-4">
                        <div class="py-2 px-xl-2">
                            <div class="text-center mb-4 pb-3 border-bottom">
                                <h2 class="h6 mb-3 pb-1">Tổng</h2>
                                <h3 class="fw-normal"><?= number_format($subtotal) ?><small>Đ</small></h3>
                            </div>
                            <a class="btn btn-primary btn-shadow d-block w-100 mt-4" href="check-out.php"><i class="ci-card fs-lg me-2"></i>Tiến hành thanh toán</a>
                        </div>
                    </div>
                </aside>
            <?php else: ?>
                <div class="col-lg-8">
                    ...
                    <a class="btn btn-outline-primary btn-sm ps-2" href="shop.php"><i class="ci-arrow-left me-2"></i>Tiếp tục mua sắm</a>
                </div>
            <?php endif; ?>
        <?php else: ?>
            <div class="col-lg-8">
